...
{
	public class BeetleBallProjectile : ModProjectile
	{	
		public override string Texture => "SpikyBalls/Content/Items/Weapons/BeetleBall";
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.position, vector1.RotateRandom(2*Math.PI), ModContent.ProjectileType<Projectiles.BeetleHomingProjectile>(), 23, 1, Projectile.owner);
			Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.position, vector1.RotateRandom(2*Math.PI), ModContent.ProjectileType<Projectiles.BeetleHomingProjectile>(), 23, 1, Projectile.owner);
		}
