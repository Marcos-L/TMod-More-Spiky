...
namespace SpikyBalls.Content.Projectiles
{
	...
	public class VenomBallProjectile : ModProjectile
	{	
		public override string Texture => "SpikyBalls/Content/Items/Weapons/VenomBall";
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => target.AddBuff(BuffID.Venom, 300);
