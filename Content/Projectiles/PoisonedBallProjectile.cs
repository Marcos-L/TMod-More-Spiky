...
namespace SpikyBalls.Content.Projectiles
{
	...
	public class PoisonedBallProjectile : ModProjectile
	{	
		public override string Texture => "SpikyBalls/Content/Items/Weapons/PoisonedBall";
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => target.AddBuff(BuffID.Poisoned, 300);
