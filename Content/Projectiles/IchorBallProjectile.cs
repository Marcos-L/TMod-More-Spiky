...
namespace SpikyBalls.Content.Projectiles
{
	...
	public class IchorBallProjectile : ModProjectile
	{	
		public override string Texture => "SpikyBalls/Content/Items/Weapons/IchorBall";
        ...
        {
			Lighting.AddLight(Projectile.position, 0.95f, 0.8f, 0.05f);
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => target.AddBuff(BuffID.Ichor, 300);
